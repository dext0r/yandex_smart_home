...
DEVICE_CLASS_TO_YANDEX_TYPES = {
    ...
    (sensor.DOMAIN, sensor.DEVICE_CLASS_TEMPERATURE): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_HUMIDITY): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_PRESSURE): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_CO): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_CO2): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_PM1): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_PM25): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_PM10): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_VOLATILE_ORGANIC_COMPOUNDS): TYPE_SENSOR_CLIMATE,
    (sensor.DOMAIN, sensor.DEVICE_CLASS_ILLUMINANCE): TYPE_SENSOR_ILLUMINATION,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_DOOR): TYPE_SENSOR_OPEN,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_WINDOW): TYPE_SENSOR_OPEN,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_GARAGE_DOOR): TYPE_SENSOR_OPEN,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_OPENING): TYPE_SENSOR_OPEN,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_MOTION): TYPE_SENSOR_MOTION,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_OCCUPANCY): TYPE_SENSOR_MOTION,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_PRESENCE): TYPE_SENSOR_MOTION,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_MOVING): TYPE_SENSOR_MOTION,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_VIBRATION): TYPE_SENSOR_VIBRATION,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_MOISTURE): TYPE_SENSOR_WATER_LEAK,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_GAS): TYPE_SENSOR_GAS,
    (binary_sensor.DOMAIN, binary_sensor.DEVICE_CLASS_SMOKE): TYPE_SENSOR_SMOKE,
}
