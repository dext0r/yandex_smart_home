...
Рецепты присланы пользователи, поэтому работоспобность не гарантируется.
...
yandex_smart_home:
  entity_config:
    media_player.androidtv:
      # https://docs.yaha-cloud.ru/master/advanced/capabilities/range/
      ...
      custom_ranges:
        volume:
          ...
          decrease_value:
            ...
            entity_id: media_player.androidtv
      # https://docs.yaha-cloud.ru/master/advanced/capabilities/mode/
      modes:
        input_source:
          one: ['HW1'] # HDMI 1
          two: ['HW2'] # HDMI 2
