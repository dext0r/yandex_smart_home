...
## Фильтры (filter)
Используются для выбора устройств, которые будут переданы в УДЯ. Если фильтры отсутсвуют (через YAML или интерфейс) - никакие устройства в УДЯ переданы не будут.

Фильтры в YAML конфигурации имеют приоритет над фильтрами, настроенными через интерфейс. Для настройки фильтров через интерфейс удалите (или закоментируйте) их в YAML конфигурации.
