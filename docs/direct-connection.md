...
Для использования прямого подключения вы самостоятельно создаёте приватный навык через Яндекс.Диалогах, который будет напрямую подключаться к вашему Home Assistant минуя облако.
...
* Нажмите иконку Плюс в правом нижнем углом, выберите "Устройство умного дома".
