...
* Выполните ручное [Обновление списка устройств](./platforms/yandex.md#discovery)
...
Если в УДЯ у устройства отсутствует функция, которая точно должна быть - попробуйте [Обновить список устройств](./platforms/yandex.md#discovery) при включенном устройстве.
