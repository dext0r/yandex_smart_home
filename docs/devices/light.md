...
3. Найдите светильник в `Настройки` --> `Инструменты разработчика` --> `Состояния`, в атрибуте `rgb_color` будет указан выбранный цвет
...
3. Найдите светильник в `Настройки` --> `Инструменты разработчика` --> `Состояния`, в атрибуте `color_temp_kelvin` будет указан температура в кельвинах
