...
from custom_components.yandex_smart_home.prop import PROPERTY_EVENT, PROPERTY_FLOAT, CustomEntityProperty
...
async def test_property_custom(hass, domain, instance):
    ...
    if domain == binary_sensor.DOMAIN and instance in [
        ...
        with pytest.raises(SmartHomeError) as e:
            CustomEntityProperty(hass, config, state, {
    ...
    prop = CustomEntityProperty(hass, config, state, {
        const.CONF_ENTITY_PROPERTY_TYPE: instance
    })
